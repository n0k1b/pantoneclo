        ...
        <table id="dataListTable" class="table ">
    	    <thead>
        	   <tr>
        		    ...
        		    <th scope="col">{{trans('file.Type Name')}}</th>
...
@include('admin.pages.faq.faq_type.create_modal')
@include('admin.pages.faq.faq_type.edit_modal')
        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                let table = $('#dataListTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('admin.faq_type.index') }}",
                    },
                    columns: [
                        {
                            data: null,
            ...
            $('#submitForm').on('submit', function (e) {
                e.preventDefault();
                $.ajax({
                    url: "{{route('admin.faq_type.store')}}",
                    method: "POST",
            ...
            $(document).on('click', '.edit', function () {
                ...
                $.ajax({
                    url: "{{route('admin.faq_type.edit')}}",
                    type: "GET",
                    data: {faq_type_id:id},
                    success: function (data) {
                        console.log(data);
                        $('#faqTypeId').val(data.faq_type.id);
                        $('#typeName').val(data.faqTypeTranslation.type_name);
                        if (data.faq_type.is_active == 1) {
            ...
            $('#updateForm').on('submit', function (e) {
                e.preventDefault();
                $.ajax({
                    url: "{{route('admin.faq_type.update')}}",
                    method: "POST",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
            ...
            $(document).on("click",".active",function(e){
                ...
                var element = this;
                $.ajax({
                    url: "{{route('admin.faq_type.active')}}",
                    type: "GET",
                    data: {id:id},
                    success: function(data){
                        if (data.errors) {
            ...
            $(document).on("click",".inactive",function(e){
                ...
                var element = this;
                $.ajax({
                    url: "{{route('admin.faq_type.inactive')}}",
                    type: "GET",
                    data: {id:id},
                    success: function(data){
                        if (data.errors) {
            ...
            $(document).on("click",".delete",function(e){
                ...
                if (!confirm('Are you sure you want to continue?')) {
                    ...
                    $.ajax({
                        url: "{{route('admin.faq_type.delete')}}",
                        type: "GET",
                        data: {id:id},
                        success: function(data){
                            $('#alert_message').fadeIn("slow");
            ...
            $("#bulk_action").on("click",function(){
                ...
                if(idsArray.length === 0){
                    ...
                    $("#active").on("click",function(){
                        ...
                        action_type = "active";
                        $.ajax({
                            url: "{{route('admin.faq_type.bulk_action')}}",
                            method: "GET",
