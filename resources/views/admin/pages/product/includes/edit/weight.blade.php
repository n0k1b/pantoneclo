            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="weight" id="weight" class="form-control @error('weight') is-invalid @enderror" id="inputEmail3" placeholder="Type Weight Value (Ex: 10)" value="{{$product->weight}}">
                            @error('weight')
                    ...
                    <div class="form-group row mt-4">
                        <div class="col-sm-12">
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" name="weight_base_calculation" @if($product->weight_base_calculation) checked @endif value="1">
