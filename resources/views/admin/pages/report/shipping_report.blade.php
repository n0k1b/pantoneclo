                        ...
                        <tbody id="reportResult">
                            @forelse ($shipping_reports as $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{ucwords(str_replace("_", ' ', $item->shipping_method))}}</td>
                                    <td>{{$item->orderDetails->count()}}</td>
                                    <td>{{ucwords(str_replace("_", ' ', $item->order_status))}}</td>
                                    <td>
                                        @if(env('CURRENCY_FORMAT')=='suffix')
                                            {{ number_format((float)$item->total, env('FORMAT_NUMBER'), '.', '') }} {{env('DEFAULT_CURRENCY_SYMBOL')}}
                                        @else
                        ...
                        <div class="card-body">
                            ...
                            <form id="filterForm" method="get">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <select class="irfan form-control selectpicker" data-live-search="true" data-live-search-style="begins" onchange="location = this.value;">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <select name="report_type" class="form-control">
                                        ...
                                        <option value="free">@lang('file.Free Shipping')</option>
                                        <option value="local_pickup">@lang('file.Local Pickup')</option>
                                        <option value="flat_rate">@lang('file.Flat Rate')</option>
                                    </select>
                                </div>
    ...
    $(function(){
      'use strict';
        ...
        $(document).ready(function () {
            ...
            // Test
            // var test = $("select[name='report_type'] option:first").text();
            // $("select[name='report_type'] option:first").text("Fahim");


            // var irfan = $(".irfan option:first").data("custom", "irfan chowdhury");
            // var customData = $(".irfan option:first").data("custom");
            // console.log(test);
            // return
            // Test
